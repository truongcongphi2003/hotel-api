...
namespace hotel_booking_data.Migrations
{
    ...
    [Migration("20250319173156_addLocationTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdministrativeRegion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AdministrativeUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("District", b =>
                {
                    b.HasOne("AdministrativeUnit", "AdministrativeUnit")
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("Province", b =>
                {
                    b.HasOne("AdministrativeRegion", "AdministrativeRegion")
                        .WithMany("Provinces")
